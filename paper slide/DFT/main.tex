...
\begin{frame}{What is quantum chemistry?}
	...
	\begin{itemize}
		\item 1. Atoms have s, p, d, f, etc orbitals.
...
\begin{frame}{Mathematical formulation}
	...
	\end{equation*}
	\begin{itemize}
		\item 1. Direct optimization of the total energy.
		\item 2. Self-consistent field (SCF) method.
		\item 3. Discretization of the wave function.
	\end{itemize}
\end{frame}
...
\begin{frame}{Basis set\footnotemark}
	\begin{itemize}
		...
		\begin{equation*}
			\varphi_{a, A, \alpha, k}^{\text{Lobe}} \equiv \sum_{k=1}^{K_A}
			D_{aAk}e^{-\alpha \norml \mfr - \mfA \normr_2^2}.
		\end{equation*}
	\end{itemize}
	\footnotetext{Gill, Peter MW. "Molecular integrals over gaussian basis
